...
(function($) {
    ...
    var NivoSlider = function(element, options){
        ...
        if(settings.directionNav){
            slider.append('<div class="nivo-directionNav"><a class="nivo-prevNav">&laquo;</a><a class="nivo-nextNav">&raquo;</a></div>');
            
            //Hide Direction nav
            if(settings.directionNavHide){
                
                $('.nivo-directionNav a', slider).animate({opacity:0.0},{duration:300});
                $('.nivo-directionNav', slider).hide();
                
                slider.hover(function(){
                    
                    $('.nivo-directionNav a', slider).animate({opacity:0.5},{duration:300});
                    $('.nivo-directionNav', slider).show();
                }, function(){
                    
                    $('.nivo-directionNav a', slider).animate({opacity:0.0},{duration:300,complete:function(){
                    $('.nivo-directionNav', slider).hide();
