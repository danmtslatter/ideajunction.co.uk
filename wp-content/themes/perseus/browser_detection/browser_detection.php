...
/*inner switch*/
	switch (floor($ver)) {
    	case 5:
        	?>
        	<html id="<?php print($thebrowser.'_'.floor($ver)); ?>" <?php language_attributes(); ?>>
        	<?php
        break;
    	case 4:
        	?>
    	...
    	default:
       ?>
       <html id="Safari" <?php language_attributes(); ?>>
       <?php
}
/*end inner*/
break;
case 'Firefox':
	...
	switch (floor($ver)) {
    	...
    	default:
       ?>
       <html id="Firefox" <?php language_attributes(); ?>>
       <?php
}
/*end inner*/
...
case 'Opera':
	...
	switch (floor($ver)) {
    	...
    	default:
       ?>
       <html id="Opera" <?php language_attributes(); ?>>
       <?php
}
/*end inner*/
